...
import { BLOCK_RICH_TEXT_FRAGMENT, BLOCK_SIMPLE_TEXT_FRAGMENT } from '~/lib/contentful/client/queries/get-category-content';
import { FragmentOf } from '~/lib/contentful/client/graphql';
